...
namespace Clover.Proxy.OldDesign
{
    public class AssemblyHelper<T>
    {
        ...
        public static bool EnableLogInputParameter =
            Convert.ToBoolean(
                ConfigurationManager.AppSettings["Clover.EnableLogInputParametersPassToInternalComponents"]);

        public static bool EnableLogReturnValue =
            Convert.ToBoolean(ConfigurationManager.AppSettings["Clover.EnableLogReturnValueFromInternalComponents"]);
        ...
        public static Assembly CreateEntityAssembly()
        {
            ...
            var sample = new CodeNamespace(TypeInformation.GetEntityNamespace(CurrentType));
...
this.{0}= {1}; ", item.Name,
        ...
        internal static Assembly CreateRemoteAssembly(Assembly entityAssembly)
        {
            ...
            var compunit = new CodeCompileUnit();
            var sample = new CodeNamespace(TypeInformation.GetRemoteNamespace(CurrentType));
            compunit.Namespaces.Add(sample);
