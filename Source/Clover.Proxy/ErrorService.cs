...
namespace Clover.Proxy
{
    ...
    public static class ErrorService
    {
        ...
        {
            return ErrorService.ConvertToString(errorCode, CultureInfo.CurrentCulture);
        }
        ...
        {
            return ErrorService.ConvertToString(ConvertFromHResult(value), CultureInfo.CurrentCulture);
        }
        ...
        {
            string errorMessage = ErrorService.GetDescription(errorCode, culture);
        ...
        {
            return ErrorService.GetDescription(errorCode, CultureInfo.CurrentCulture);
        }
        ...
        {
            return ErrorService.GetDescription(ConvertFromHResult(value), CultureInfo.CurrentCulture);
        }
            ...
            where T : Exception
        {
            ...
            string errorMessage = ErrorService.ConvertToString(errorCode, CultureInfo.CurrentCulture);
            T exception = (T)Activator.CreateInstance(typeof(T), errorMessage, innerException);
        ...
        public static T CreateException<T>(ErrorCode errorCode, params object[] formatArgs)
            where T : Exception
        {
            string errorMessage = ErrorService.FormatErrorCode(errorCode, CultureInfo.CurrentCulture, formatArgs);
            T exception = (T)Activator.CreateInstance(typeof(T), errorMessage);
            exception.Data.Add("ErrorCode", errorCode);
        ...
        public static string FormatErrorCode(ErrorCode errorCode, CultureInfo culture, params object[] args)
        {
            return string.Format(
                culture,
                ErrorService.ConvertToString(errorCode, culture),
                args);
        }
